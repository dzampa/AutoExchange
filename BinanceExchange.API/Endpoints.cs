...
namespace BinanceExchange.API
{
    public static class Endpoints
    {
        ...
        public static class MarketData
        {
            ...
            /// <summary>
            /// 24 hour price change statistics. With Symbol
            /// </summary>
            ...
            /// 24 hour price change statistics. With Symbol
            /// </summary>
            public static BinanceEndpointData DayPriceTicker24()
            {
                return new BinanceEndpointData(new Uri($"{APIPrefix}/{ApiVersion}/ticker/24hr"),
                         EndpointSecurityType.None);
            }            
