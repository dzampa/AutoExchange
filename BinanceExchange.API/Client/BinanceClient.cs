...
namespace BinanceExchange.API.Client
{
    ...
    public class BinanceClient : IBinanceClient
    {
        ...
        /// <summary>
        /// Gets the Daily price ticker 
        /// </summary>
        /// <returns></returns>
        public async Task<List<SymbolPriceChangeTickerResponse24>> GetDailyTicker24()
        {
            return await _apiProcessor.ProcessGetRequest<List<SymbolPriceChangeTickerResponse24>>(Endpoints.MarketData.DayPriceTicker24()); 
        }
